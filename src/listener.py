...
def send_influx_data(meter, value, timestamp=None, table="usage"):
...
def on_message(*args):
    ...
    send_influx_data('meter1', value=energy_info.get('total_usage_night'), timestamp=power_meter_time)
    send_influx_data('meter2', value=energy_info.get('total_usage_day'), timestamp=power_meter_time)
    send_influx_data('gas', value=energy_info.get('gas_usage_total'), timestamp=gas_meter_time)
